...
path="~/.i3/scripts/measure-net-speed.log"
...
enp7s0="/sys/devices/pci0000:00/0000:00:1c.3/0000:07:00.0/net/enp7s0/statistics"
wlp6s0="/sys/devices/pci0000:00/0000:00:1c.2/0000:06:00.0/net/wlp6s0/statistics"
read enp7s0_rx < "${enp7s0}/rx_bytes"
read enp7s0_tx < "${enp7s0}/tx_bytes"
read wlps0_rx < "${wlps0}/rx_bytes"
read wlps0_tx < "${wlps0}/tx_bytes"

# get time and sum of rx/tx for combined display
time=$(date +%s)
rx=$(( $enp7s0_rx + $wlps0_rx ))
tx=$(( $enp7s0_tx + $wlps0_tx ))
